...
header_program        : INICIO_PROGRAMA | error;
...
var_body              : type array_or_id | error;

type                  : primitive_type | error;
...
header_subprogram     : type IDENTIFIER LEFT_BRACKET parameters RIGHT_BRACKET | type IDENTIFIER LEFT_BRACKET RIGHT_BRACKET;
...
expr                  : LEFT_BRACKET expr RIGHT_BRACKET
                         | PLUSLESS expr %prec UNARY_OPERATOR
                         |  UNARY_OPERATOR expr
| expr PLUSLESS expr
| expr OP_MUL expr
| expr OP_REL expr
